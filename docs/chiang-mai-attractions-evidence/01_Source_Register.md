...
`data/research/chiang-mai-attractions-sources.json`. It contains eight official
sources: five Chiang Mai Provincial Office sources and three Tourism Authority
