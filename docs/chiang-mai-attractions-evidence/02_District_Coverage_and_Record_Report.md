...
All 25 Chiang Mai districts are represented in the coverage matrix. Eleven
districts contain one evidence record; fourteen intentionally remain coverage
...
- Districts with a retained record: 11
- Coverage-gap districts: 14
- Publication eligible: 0
- Rights cleared: 0
- Media rights cleared: 0
- Records with coordinates: 0
- Records with asserted opening hours, admission, or accessibility: 0

Every retained record is blocked. The detailed per-district gap is preserved in
`data/research/chiang-mai-attractions-coverage.json`; candidate exclusions and
their concise reasons are in
`data/research/chiang-mai-attractions-exclusions.json`.
