...
// Traveler mutations are server-only and intentionally fail closed without the
// service-role credential. The publishable key must never impersonate this boundary.
